...
```docker run iotaledger/iri:v1.6.1-RELEASE-BETA -p 14265```
...
```docker run -v /path/to/conf:/iri/conf -v /path/to/data:/iri/data iotaledger/iri:v1.6.1-RELEASE-BETA -p 14265 -c /iri/conf/iri.ini```
...
-p 15600:15600 \
-p 14600:14600/udp  \
iotaledger/iri:v1.6.1-RELEASE-BETA \
-p 14265 \
--zmq-enabled \
--testnet
