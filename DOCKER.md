...
```docker run iotaledger/iri:v1.6.0-RC8 -p 14265```
...
```docker run -v /path/to/conf:/iri/conf -v /path/to/data:/iri/data iotaledger/iri:v1.6.0-RC8 -p 14265 -c /iri/conf/iri.ini```
