\begin{abstract}
To achieve high throughput in the POW based blockchain systems, a series of methods has been proposed, 
...
To scale up, we leveraged the graph streaming property,
high transaction validation speed will be achieved even if the DAG is growing.
To scale out, we designed the `direct signal' gossip protocol to help disseminate block updates in the network,
such that message can be passed in the network in a more efficient way.
