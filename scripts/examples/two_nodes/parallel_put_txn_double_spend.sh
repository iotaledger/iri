...
curl -s http://localhost:6000/put_file -X POST -H "Content-Type: application/json" -d "{\"from\":\"a\",\"to\":\"e\",\"amnt\":1000,\"tag\":\"TX\"}" &
curl -s http://localhost:6000/put_file -X POST -H "Content-Type: application/json" -d "{\"from\":\"a\",\"to\":\"f\",\"amnt\":1000,\"tag\":\"TX\"}" &
curl -s http://localhost:6000/put_file -X POST -H "Content-Type: application/json" -d "{\"from\":\"a\",\"to\":\"g\",\"amnt\":1000,\"tag\":\"TX\"}" &
curl -s http://localhost:6000/put_file -X POST -H "Content-Type: application/json" -d "{\"from\":\"a\",\"to\":\"h\",\"amnt\":1000,\"tag\":\"TX\"}" &
curl -s http://localhost:6000/put_file -X POST -H "Content-Type: application/json" -d "{\"from\":\"a\",\"to\":\"i\",\"amnt\":1000,\"tag\":\"TX\"}" &
