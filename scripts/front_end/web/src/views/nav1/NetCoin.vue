<template>
    <el-form ref="form" :model="form" label-width="80px" @submit.prevent="onSubmit"
        ...
        <el-form-item label="Trans: " label-width="150px;">
            <label>&nbsp;&nbsp;&nbsp;&nbsp;From: &nbsp;</label>
            <el-input class="input-large" placeholder="Input source account"
                      @change="setSource"/>
            <label>To: </label>
            <el-input class="input-large" placeholder="Input target account"
                      @change="setTarget"/>
            <label>Balance: </label>
            <el-input class="input-medium" placeholder="Input balance"
                      @change="setTarnsBalance"/>
            <el-button @click="getBalance" type="success">Commit Transaction</el-button>
        </el-form-item>
