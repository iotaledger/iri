...
java -jar /home/ubuntu/iota/run-time/iri-1.5.5.jar --testnet --testnet-no-coo-validation --snapshot=/home/ubuntu/iota/run-time/Snapshot.txt --mwm 1 -p 14700 --max-peers 40 --remote &>  /home/ubuntu/iota/run-time/out &
