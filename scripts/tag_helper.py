...
class TagHelper(object):
    ...
    @classmethod
    def get_current_tag(cls):
        today = datetime.date.today()
        return TagHelper.TAG_YEAR[today.year] + \
            TagHelper.TAG_MONTH[today.month] + \
            TagHelper.TAG_DAY[today.day]
    ...
    def get_previous_tag(cls):
        ...
        return TagHelper.TAG_YEAR[yesterday.year] + \
            TagHelper.TAG_MONTH[yesterday.month] + \
            TagHelper.TAG_DAY[yesterday.day]
