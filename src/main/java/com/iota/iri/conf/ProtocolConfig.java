...
public interface ProtocolConfig extends Config {
    ...
    interface Descriptions {
        ...
        String REQUEST_HASH_SIZE = "The size of the requested hash in a packet. It's size is derived from the minimal MWM value the network accepts. The larger the MWM -> the more trailing zeroes we can ignore -> smaller hash size.";
        ...
        String P_SELECT_MILESTONE = DescriptionHelper.PROB_OF + "requesting a milestone transaction from a neighbor. This should be a high since it is imperative that we find milestones to get transactions confirmed";
        ...
        //TODO add a better explanation
        String P_REPLY_RANDOM_TIP = DescriptionHelper.PROB_OF + "replying with a random transaction when no transaction is requested by a neighbor.";
