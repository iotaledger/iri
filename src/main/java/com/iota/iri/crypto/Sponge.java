...
public interface Sponge {
    ...
    /**
     * Absorbs {@code trits}, in chunks of {@link #HASH_LENGTH}.<br>
     ...
     * @param length amount of trits to absorb, multiple of {@link #HASH_LENGTH}
     */
    void absorb(final byte[] trits, int offset, int length);

    /**
     * Squeezes {@code length} trits from the sponge, in chunks of {@link #HASH_LENGTH}.<br>
     ...
     * @param length amount of trits to squeeze, multiple of {@link #HASH_LENGTH}
     */
