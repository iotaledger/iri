...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
	...
	byte[] aALPHABET = getAlphabet( options );
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    byte[] destination, int destOffset, int options ) {
        ...
        byte[] dDECODABET = getDecodabet( options );
        ...
        if( source[ srcOffset + 2] == EQUALS_SIGN ) {
          ...
          //              | ( ( DECODABET[ source[ srcOffset + 1] ] << 24 ) >>> 12 );
            int outBuff =   ( ( dDECODABET[ source[ srcOffset    ] ] & 0xFF ) << 18 )
                          | ( ( dDECODABET[ source[ srcOffset + 1] ] & 0xFF ) << 12 );
        ...
        // Example: DkL=
          ...
          //              | ( ( DECODABET[ source[ srcOffset + 2 ] ] << 24 ) >>> 18 );
            int outBuff =   ( ( dDECODABET[ source[ srcOffset     ] ] & 0xFF ) << 18 )
                          | ( ( dDECODABET[ source[ srcOffset + 1 ] ] & 0xFF ) << 12 )
                          | ( ( dDECODABET[ source[ srcOffset + 2 ] ] & 0xFF ) <<  6 );
        ...
        // Example: DkLE
          ...
          //              | ( ( DECODABET[ source[ srcOffset + 3 ] ] << 24 ) >>> 24 );
            int outBuff =   ( ( dDECODABET[ source[ srcOffset     ] ] & 0xFF ) << 18 )
                          | ( ( dDECODABET[ source[ srcOffset + 1 ] ] & 0xFF ) << 12 )
                          | ( ( dDECODABET[ source[ srcOffset + 2 ] ] & 0xFF ) <<  6)
                          | ( ( dDECODABET[ source[ srcOffset + 3 ] ] & 0xFF )      );
...
//        }
    ...
    throws java.io.IOException {
        ...
        for( i = off; i < off+len; i++ ) {  // Loop through source
            ...
            sbiDecode = dDECODABET[ source[i]&0xFF ];
