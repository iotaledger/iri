...
public final class UDPNeighbor extends Neighbor {
    ...
    UDPNeighbor(final int tcpReceiverPort, final int udpReceiverPort, InetSocketAddress address, DatagramSocket datagramSocket, boolean isConfigured) {
        super(tcpReceiverPort, udpReceiverPort, address, isConfigured);
    ...
    public void send(byte[] data) {
        ...
        try {
            ...
            if (log.isDebugEnabled()) log.debug("Error sending UDP packet to [{}]: {}", getAddress(), e.toString());
        }
    }
