...
public class ReplyStage {
    ...
    public ReplyStage(
            NeighborRouter neighborRouter, NodeConfig config, Tangle tangle,
    ...
    public void process(ProcessingContext ctx) {
        ...
        if (hashOfRequestedTx.equals(Hash.NULL_HASH)) {
            ...
            try {
                ...
                tvm = TransactionViewModel.fromHash(tangle, HashFactory.TRANSACTION.create(hashOfRequestedTx.bytes(), 0, Protocol.GOSSIP_REQUESTED_TX_HASH_BYTES));
            } catch (Exception e) {
