...
public class TCPSourceReport extends ScheduledTask {

    private static final Logger log = LoggerFactory.getLogger(TCPSourceReport.class);
    private final NeighborManager neighborManager;

    public TCPSourceReport(Duration duration, NeighborManager neighborManager) {
        super(duration);
    ...
    public void task() {
        ...
        neighborManager.forEach(TCPNeighbor.class, n -> {
            ...
            if (stats != null) {
                ...
                log.info("{} [OUTGOING] {} tps {}  {}=" +
                                "{}[sent direct {}  queued {}] " +
                                "{}=[drops waitCnct {} busy {}  rate {}  queue {}  nopermit {}  err {}] " +
                                "retried {}",
                        ...
                        Format.leftpad(Format.readableNumber(stats.getPacketsDroppedConnectionRefused()), 4),
