...
public class TipsManager {
    ...
    Hash transactionToApprove(final Hash reference, final Hash extraTip, final int depth, final int iterations, Random seed) {
        ...
        if(milestone.latestSolidSubtangleMilestoneIndex > Milestone.MILESTONE_START_INDEX ||
            ...
            try {
                Hash hash = reference == null ? milestone.latestSolidSubtangleMilestone : reference;
                ...
                if (extraTip != null) {
                    ...
                    if(milestoneViewModel != null && milestoneViewModel.getHash() != null) {
                        hash = milestoneViewModel.getHash();
                    }
                }
                ...
                for(int i = iterations; i-- > 0; ) {
                    ...
                    while (hash != null) {
                        ...
                        tips = (Hash[]) transactionViewModel.getApprovers(tangle).getHashes().toArray();
                        ...
                        if(tips.length == 0) {
                            ...
                            hash = tips[approverIndex];
                            if (transactionViewModel.getHash().equals(hash)) {
