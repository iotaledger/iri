...
/**
 * Any object that can be serialized and stored in the DB.
 *
 * @see Indexable
 */
public interface Persistable extends Serializable {
     ...
     * fields that represent the object in other nodes in the network.
     *
     ...
     *
     * @param bytes the serialized version the object
     */
    void read(byte[] bytes);

    /**
     * Serializes fields that usually contain data about the object that the node itself calculates
     * and is not passed to different nodes. This data is supposed to be stored in a different column family/table then
    ...
    /**
     * Specifies whether the object should be appended to an existing key/index or should it replace the old
     * indexed object.
     *
