...
public class TransactionValidatorTest {
  ...
  public void testTransactionPropagationFailure() throws Exception {
    ...
    TransactionViewModel parent = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(leftChildLeaf.getHash(),
    ...
    TransactionViewModel grandParent = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(parent.getHash(),
