...
public class HashTest {
    ...
    public void calculate() throws Exception {
        Hash hash = Hash.calculate(SpongeFactory.Mode.CURL, TransactionViewModelTest.getRandomTransactionTrits());
    ...
    public void calculate1() throws Exception {
        Hash hash = Hash.calculate(TransactionViewModelTest.getRandomTransactionTrits(), 0, 729, SpongeFactory.create(SpongeFactory.Mode.CURL));
        Assert.assertNotEquals(null, hash.bytes());
        Assert.assertNotEquals(0, hash.hashCode());
        Assert.assertNotEquals(null, hash.trits());
    }
    ...
    public void calculate2() throws Exception {
        Hash hash = Hash.calculate(Converter.bytes(TransactionViewModelTest.getRandomTransactionTrits()), TransactionViewModel.TRINARY_SIZE, SpongeFactory.create(SpongeFactory.Mode.CURL));
        Assert.assertNotEquals(0, hash.hashCode());
        Assert.assertNotEquals(null, hash.bytes());
        Assert.assertNotEquals(null, hash.trits());
    }
    ...
    public void equals() throws Exception {
        ...
        Hash hash1 = Hash.calculate(SpongeFactory.Mode.CURL, trits);
        Assert.assertTrue(hash.equals(hash1));
        Assert.assertFalse(hash.equals(Hash.NULL_HASH));
        Assert.assertFalse(hash.equals(Hash.calculate(SpongeFactory.Mode.CURL, TransactionViewModelTest.getRandomTransactionTrits())));
    }
