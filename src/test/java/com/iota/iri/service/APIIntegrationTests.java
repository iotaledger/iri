...
public class APIIntegrationTests {
    ...
    private static ResponseSpecification specResponseSuccess;
    private static ResponseSpecification specResponseError;
