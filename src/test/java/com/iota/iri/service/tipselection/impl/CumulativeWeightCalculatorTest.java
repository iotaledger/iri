...
public class CumulativeWeightCalculatorTest {
    ...
    public void testCalculateCumulativeWeight() throws Exception {
        ...
        OptimizedMap<Indexable, Integer> txToCw = cumulativeWeightCalculator.calculate(transaction.getHash());
    ...
    public void cwCalculationSameAsLegacy() throws Exception {
        ...
        OptimizedMap<Indexable, Integer> txToCw = cumulativeWeightCalculator.calculate(hashes[0]);
