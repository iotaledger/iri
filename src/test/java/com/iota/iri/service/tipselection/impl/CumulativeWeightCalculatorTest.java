...
public class CumulativeWeightCalculatorTest {
    ...
    public void testCalculateCumulativeWeightDiamond() throws Exception {
        ...
        transaction1 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction.getHash(),
                transaction.getHash()), getRandomTransactionHash());
        transaction2 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction.getHash(),
                transaction.getHash()), getRandomTransactionHash());
        transaction3 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction1.getHash(),
    ...
    public void testCalculateCumulativeWeightLinear() throws Exception {
        TransactionViewModel transaction, transaction1, transaction2, transaction3, transaction4;
        transaction = new TransactionViewModel(getRandomTransactionTrits(), getRandomTransactionHash());
        transaction1 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
                transaction.getHash(), transaction.getHash()), getRandomTransactionHash());
        transaction2 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
                transaction1.getHash(), transaction1.getHash()), getRandomTransactionHash());
        transaction3 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
                transaction2.getHash(), transaction2.getHash()), getRandomTransactionHash());
        transaction4 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
    ...
    public void testCalculateCumulativeWeight2() throws Exception {
        ...
        transaction4 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
                transaction.getHash(), transaction.getHash()), getRandomTransactionHash());
        transaction5 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
                transaction3.getHash(), transaction2.getHash()), getRandomTransactionHash());
        transaction6 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
    ...
    public void cwCalculationSameAsLegacy() throws Exception {
        ...
        for (int i = 1; i < hashes.length; i++) {
            ...
            TransactionViewModel transactionViewModel = new TransactionViewModel(
                    getRandomTransactionTritsWithTrunkAndBranch(hashes[i - random.nextInt(i) - 1],
    ...
    public void testTangleWithCircle() throws Exception {
        ...
        transaction = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(randomTransactionHash, randomTransactionHash), randomTransactionHash);
    ...
    public void testTangleWithCircle2() throws Exception {
        ...
        transaction = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(
    ...
    private long ratingTime(int size) throws Exception {
        ...
        for (int i = 1; i < hashes.length; i++) {
            hashes[i] = getRandomTransactionHash();
            new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(hashes[i - random.nextInt(i) - 1],
