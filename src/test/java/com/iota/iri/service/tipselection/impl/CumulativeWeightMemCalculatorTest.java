...
public class CumulativeWeightMemCalculatorTest {
    ...
    private static CumulativeWeightMemCalculator cumulativeWeightCalculator;
    ...
    public void testCollsionsInDiamondTangle() throws Exception {
        ...
        Assert.assertEquals(String.format(TX_CUMULATIVE_WEIGHT_IS_NOT_AS_EXPECTED_FORMAT, 0),
                4, txToCw.get(transaction.getHash()).intValue());  //FIXME sth conflict here!!!!
    }
