...
public class WalkValidatorImplTest {
    ...
    public void belowMaxDepthWithFreshMilestone() throws Exception {
        ...
        Hash hash = tx.getHash();
        for (int i = 0; i < 4 ; i++) {
            tx = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(hash, hash), getRandomTransactionHash());
    ...
    public void failBelowMaxDepthWithFreshMilestoneDueToLongChain() throws Exception {
        ...
        for (int i = 0; i < maxAnalyzedTxs ; i++) {
            tx = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(hash, hash),
    ...
    public void dontMarkWrongTxsAsBelowMaxDepth() throws Exception {
        ...
        TransactionViewModel tx2 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(tx1.getHash(), tx1.getHash()),
                getRandomTransactionHash());
        ...
        TransactionViewModel tx3 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(tx1.getHash(), txBad.getHash()),
                getRandomTransactionHash());
        ...
        TransactionViewModel tx4 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(tx2.getHash(), tx3.getHash()),
                getRandomTransactionHash());
