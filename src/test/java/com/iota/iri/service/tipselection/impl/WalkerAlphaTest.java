...
public class WalkerAlphaTest {
    ...
    public void testWalkEndsOnlyInRating() throws Exception {
        ...
        transaction2 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction.getHash(),
                transaction.getHash()), getRandomTransactionHash());
        transaction3 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction.getHash(),
                transaction.getHash()), getRandomTransactionHash());
        ...
        transaction4 = new TransactionViewModel(getRandomTransactionTritsWithTrunkAndBranch(transaction.getHash(),
                transaction.getHash()), getRandomTransactionHash());
